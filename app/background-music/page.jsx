                ...
                <div className="bg-content-sub">
                    <div className="cont">
                        ...
                        <div className="bg-heading">
                            <span className="bg-heading-span">Select Your Background Music</span>
                        </div>
                    </div>
                    ...
                    <form method="POST" id="bg_form" encType="multipart/form-data">
                        <div className="file-upload-container" id="targetDiv">
                            ...
                            <div id="musicContainer">
                                ...
                                {mp3Templates.map((template) => (
                                    <div key={template.id} className="uploadmp3">
                                        <div className="uploadmp3-sub">
                                            <div className="text">
                                                <span>Upload MP3 <span>{template.id}</span>:</span>
                                            </div>
                                            {template.id !== 1 && mp3Templates.length > 1 && (
                                                <button
                                                    type="button"
                                                    className="delete"
                                        ...
                                        <div className="text">
                                            <span>What Second Should This MP3 Play From? <span className="text-span">In Minutes</span></span>
                                        </div>
                                        <div className="start-main-div">
                                            <div className="start-sub-div">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleInputChange(template.id, 'startTime', e.target.value)}
                                                />
                                            </div>
                                            <div className="start-sub-div">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleInputChange(template.id, 'endTime', e.target.value)}
                                                />
                                            </div>
                                        </div>
                                        <div>
                                            <div className="Font-Size-text">
                                                <div className="mp3-volume">MP3 {template.id} Volume:</div>
                                                <span>{template.volume}%</span>
                                            </div>
                                            <div className="Font-Size-Slider">
                                                <input
                                                    ...
                                                    className="slider"
                                                    onChange={(e) => {
                                                        handleInputChange(template.id, 'volume', parseInt(e.target.value));
                                ...
                                <button type="button" id="addMusicBtn" className="button" onClick={handleAddMp3}>
