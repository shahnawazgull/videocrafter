    ...
    <div className='main-sub'>
      ...
      <div className="outer">
        <div className="info-header">
          ...
          <Link href="/billing-portal">Manage Billing Info
          </Link>
        </div>
      ...
      <div className="plans">
        <div className="box">
          ...
          <p id="p" style={{ minHeight: '70px' }}>
            <img src="/images/check.svg" alt="Check icon" /> Create up to 25 VSLs per month
          </p>
          <Link href="/accounts/">Upgrade Subscription
          </Link>
        </div>
        ...
        <div className="box">
          ...
          <p id="p" style={{ minHeight: '70px' }}>
            <img src="/images/check.svg" alt="Check icon" /> Create up to 60 VSLs per month
          </p>
          <Link href="/accounts/">Upgrade Subscription
          </Link>
        </div>
